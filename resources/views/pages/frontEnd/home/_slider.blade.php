                ...
                <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner shadow-sm rounded">
                        ...
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset("assets-frontEnd/img/slides/slide2.jpg") }}" alt="Second slide">
                            <div class="carousel-caption d-none d-md-block">
                                <h5>Freedom, Sea Collection</h5>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset("assets-frontEnd/img/slides/slide3.jpg") }}" alt="Third slide">
                            <div class="carousel-caption d-none d-md-block">
